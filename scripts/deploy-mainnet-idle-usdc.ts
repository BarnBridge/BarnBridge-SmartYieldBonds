...
const seniorBondCONF = { name: 'BarnBridge idleUSDC sBOND', symbol: 'bb_sBOND_idleUSDC' };
const juniorBondCONF = { name: 'BarnBridge idleUSDC jBOND', symbol: 'bb_jBOND_idleUSDC' };
const juniorTokenCONF = { name: 'BarnBridge junior idleUSDC', symbol: 'bb_idleUSDC' };
...
async function main() {
  ...
  const pool = await deployIdleProvider(deployerSign, idleUSDC);
