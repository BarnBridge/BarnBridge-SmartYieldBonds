...
const juniorTokenCONF = { name: 'BarnBridge junior crUSDT', symbol: 'bb_crUSDT' };
...
async function main() {
  ...
  const pool = await deployCreamProvider(deployerSign, crUSDT);
  ...
  console.log('provider:', pool.address, '[', crUSDT, ']');
