...
const seniorBondCONF = { name: 'BarnBridge aRAI sBOND', symbol: 'bb_sBOND_aRAI' };
const juniorBondCONF = { name: 'BarnBridge aRAI jBOND', symbol: 'bb_jBOND_aRAI' };
const juniorTokenCONF = { name: 'BarnBridge junior aRAI', symbol: 'bb_aRAI' };

const oracleCONF = { windowSize: 3 * A_DAY, granularity: 4 };

// barnbridge
const decimals = 18; // same as RAI
const feesOwner = '0x4cAE362D7F227e3d306f70ce4878E245563F3069';

// externals ---

// aave
const aRAI = '0xc9BC48c72154ef3e5425641a3c747242112a46AF';
...
async function main() {
  ...
  const pool = await deployAaveProvider(deployerSign, aRAI);
  ...
  console.log('provider:', pool.address, '[', aRAI, ']');
