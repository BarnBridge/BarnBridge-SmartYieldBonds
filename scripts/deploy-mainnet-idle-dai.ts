...
const seniorBondCONF = { name: 'BarnBridge idleDAI sBOND', symbol: 'bb_sBOND_idleDAI' };
const juniorBondCONF = { name: 'BarnBridge idleDAI jBOND', symbol: 'bb_jBOND_idleDAI' };
const juniorTokenCONF = { name: 'BarnBridge junior idleDAI', symbol: 'bb_idleDAI' };
...
async function main() {
  ...
  const pool = await deployIdleProvider(deployerSign, idleDAI);
