...
const juniorTokenCONF = { name: 'BarnBridge junior crDAI', symbol: 'bb_crDAI' };
...
async function main() {
  ...
  const pool = await deployCreamProvider(deployerSign, crDAI);
