...
const seniorBondCONF = { name: 'BarnBridge aGUSD sBOND', symbol: 'bb_sBOND_aGUSD' };
const juniorBondCONF = { name: 'BarnBridge aGUSD jBOND', symbol: 'bb_jBOND_aGUSD' };
const juniorTokenCONF = { name: 'BarnBridge junior aGUSD', symbol: 'bb_aGUSD' };

const oracleCONF = { windowSize: 3 * A_DAY, granularity: 4 };

// barnbridge
const decimals = 2; // same as GUSD
const feesOwner = '0x4cAE362D7F227e3d306f70ce4878E245563F3069';

// externals ---

// aave
const aGUSD = '0xD37EE7e4f452C6638c96536e68090De8cBcdb583';
...
async function main() {
  ...
  const pool = await deployAaveProvider(deployerSign, aGUSD);
  ...
  console.log('provider:', pool.address, '[', aGUSD, ']');
