...
contract CTokenYieldingMock is ICToken, ERC20 {
    uint256 public exchangeRateStored_ = 0;

    address public override comptroller;
    address public override underlying;

    IClockProvider public clock;

    uint256 public lastYielded;
    uint256 public yieldPerDay;
    uint256 public exchangeRateInitial;

    constructor(address underlying_, address comptroller_, address clock_, uint256 exchangeRateInitial_) ERC20("cDAI Mock", "cDAI") {
        underlying = underlying_;
        comptroller = comptroller_;
        clock = IClockProvider(clock_);
    ...
    function exchangeRateStored() public override view returns (uint256) {
      ...
      uint256 elapsed = clock.currentTime() - lastYielded;
